...
export default function HomeDebugPage() {
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold mb-6">Home Page Debug</h1>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    ...
                    <button
                        ...
                        className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg mr-4"
                    >
                        Load Events
                    </button>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    ...
                    <p className="text-sm text-gray-600">
                        Check the browser console for any error messages or logs from the Home component.
                    </p>
                </div>
            </div>
        </div>
