...
export default function DiscoverPage() {
    ...
    const getMarkerIcon = (category: string) => {
        switch (category.toUpperCase()) {
            ...
            case 'FOOD':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>';
            case 'SPORTS':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>';
            case 'FASHION':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M20.38 3.46L16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"></path></svg>';
            case 'EDUCATION':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M22 9l-10-4L2 9l10 4 10-4z"></path><path d="M2 14l10 4 10-4"></path><path d="M6 15.5v5l6-2.5 6 2.5v-5"></path></svg>';
            case 'BUSINESS':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg>';
            case 'HEALTH':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>';
            case 'TRAVEL':
            ...
            case 'ENTERTAINMENT':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><circle cx="12" cy="12" r="10"></circle><polygon points="10,8 16,12 10,16 10,8"></polygon></svg>';
            case 'NIGHTLIFE':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M21 12c0 1.2-4.03 6-9 6s-9-4.8-9-6c0-1.2 4.03-6 9-6s9 4.8 9 6z"></path><circle cx="12" cy="12" r="3"></circle></svg>';
            case 'FAMILY':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>';
            case 'COMMUNITY':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>';
            case 'CHARITY':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>';
            case 'POLITICS':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>';
            case 'RELIGION':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>';
            case 'SCIENCE':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M9 11H5a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2h-4"></path><path d="M9 7l3-3 3 3"></path><path d="M12 4v8"></path></svg>';
            case 'CULTURE':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>';
            case 'LIFESTYLE':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>';
            case 'AUTOMOTIVE':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18.7 9H5.3l-1.8 2.1C2.7 11.3 2 12.1 2 13v3c0 .6.4 1 1 1h2m14 0H5m14 0v3c0 .6-.4 1-1 1H6c-.6 0-1-.4-1-1v-3"></path><circle cx="7" cy="17" r="2"></circle><circle cx="17" cy="17" r="2"></circle></svg>';
            case 'REAL_ESTATE':
            ...
            case 'FINANCE':
                return '<svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>';
            default:
    ...
    const categories: Array<EventCategory | 'ALL'> = ['ALL', 'MUSIC', 'CONFERENCE', 'ART', 'GAMING', 'FILM', 'TECHNOLOGY', 'WORKSHOP', 'OUTDOOR', 'WELLNESS', 'FOOD', 'SPORTS', 'FASHION', 'EDUCATION', 'BUSINESS', 'HEALTH', 'TRAVEL', 'ENTERTAINMENT', 'NIGHTLIFE', 'FAMILY', 'COMMUNITY', 'CHARITY', 'POLITICS', 'RELIGION', 'SCIENCE', 'CULTURE', 'LIFESTYLE', 'AUTOMOTIVE', 'REAL_ESTATE', 'FINANCE'];
    ...
    return (
        <div className="relative min-h-screen">
            ...
            <main className="pt-20 pb-20">
                <div className="bg-white pt-4 pb-2">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="py-2 flex gap-2 overflow-x-auto hide-scrollbar justify-center">
            ...
            <style jsx global>{`
                ...
                .marker-pin.food { border-color: #FF9800; }
                .marker-pin.food .marker-icon { color: #FF9800; }
                .marker-pin.food.selected { background: #FF9800; }
                
                .marker-pin.sports { border-color: #4CAF50; }
                .marker-pin.sports .marker-icon { color: #4CAF50; }
                .marker-pin.sports.selected { background: #4CAF50; }
                
                .marker-pin.fashion { border-color: #E91E63; }
                .marker-pin.fashion .marker-icon { color: #E91E63; }
                .marker-pin.fashion.selected { background: #E91E63; }
                
                .marker-pin.education { border-color: #3F51B5; }
                .marker-pin.education .marker-icon { color: #3F51B5; }
                .marker-pin.education.selected { background: #3F51B5; }
                
                .marker-pin.business { border-color: #607D8B; }
                .marker-pin.business .marker-icon { color: #607D8B; }
                .marker-pin.business.selected { background: #607D8B; }
                
                .marker-pin.health { border-color: #F44336; }
                .marker-pin.health .marker-icon { color: #F44336; }
                .marker-pin.health.selected { background: #F44336; }
                
                .marker-pin.travel { border-color: #009688; }
                .marker-pin.travel .marker-icon { color: #009688; }
                .marker-pin.travel.selected { background: #009688; }
                
                .marker-pin.entertainment { border-color: #9C27B0; }
                .marker-pin.entertainment .marker-icon { color: #9C27B0; }
                .marker-pin.entertainment.selected { background: #9C27B0; }
                
                .marker-pin.nightlife { border-color: #673AB7; }
                .marker-pin.nightlife .marker-icon { color: #673AB7; }
                .marker-pin.nightlife.selected { background: #673AB7; }
                
                .marker-pin.family { border-color: #FF5722; }
                .marker-pin.family .marker-icon { color: #FF5722; }
                .marker-pin.family.selected { background: #FF5722; }
                
                .marker-pin.community { border-color: #795548; }
                .marker-pin.community .marker-icon { color: #795548; }
                .marker-pin.community.selected { background: #795548; }
                
                .marker-pin.charity { border-color: #E91E63; }
                .marker-pin.charity .marker-icon { color: #E91E63; }
                .marker-pin.charity.selected { background: #E91E63; }
                
                .marker-pin.politics { border-color: #FFC107; }
                .marker-pin.politics .marker-icon { color: #FFC107; }
                .marker-pin.politics.selected { background: #FFC107; }
                
                .marker-pin.religion { border-color: #8BC34A; }
                .marker-pin.religion .marker-icon { color: #8BC34A; }
                .marker-pin.religion.selected { background: #8BC34A; }
                
                .marker-pin.science { border-color: #00BCD4; }
                .marker-pin.science .marker-icon { color: #00BCD4; }
                .marker-pin.science.selected { background: #00BCD4; }
                
                .marker-pin.culture { border-color: #FF9800; }
                .marker-pin.culture .marker-icon { color: #FF9800; }
                .marker-pin.culture.selected { background: #FF9800; }
                
                .marker-pin.lifestyle { border-color: #607D8B; }
                .marker-pin.lifestyle .marker-icon { color: #607D8B; }
                .marker-pin.lifestyle.selected { background: #607D8B; }
                
                .marker-pin.automotive { border-color: #9E9E9E; }
                .marker-pin.automotive .marker-icon { color: #9E9E9E; }
                .marker-pin.automotive.selected { background: #9E9E9E; }
                
                .marker-pin.real_estate { border-color: #795548; }
                .marker-pin.real_estate .marker-icon { color: #795548; }
                .marker-pin.real_estate.selected { background: #795548; }
                
                .marker-pin.finance { border-color: #4CAF50; }
                .marker-pin.finance .marker-icon { color: #4CAF50; }
                .marker-pin.finance.selected { background: #4CAF50; }
